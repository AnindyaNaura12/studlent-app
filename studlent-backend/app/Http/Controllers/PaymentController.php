...
class PaymentController extends Controller
{
    ...
    public function initiatePayment(Request $request, MidtransService $midtrans)
    {
        ...
        try {
            ...
            DB::rollBack();
            Log::error('initiatePayment error', ['message' => $e->getMessage()]);
        ...
        try {
            ...
            if (in_array($transactionStatus, ['capture', 'settlement'])) {
                if ($transactionStatus === 'capture' && $fraudStatus === 'challenge') {
                    ...
                    $payment->save();
                    DB::commit();
                    return response()->json(['message' => 'Challenge']);
                }
            ...
            if (in_array($transactionStatus, ['cancel', 'deny', 'expire', 'failure'])) {
                ...
                DB::commit();
                return response()->json(['message' => 'Failed/expired']);
            }
            ...
            DB::rollBack();
            Log::error('handleNotification error', ['message' => $e->getMessage()]);
    ...
    public function completeOrder(Request $request, FeeService $feeService, WalletService $walletService)
    {
        ...
        DB::transaction(function () use ($order, $payment, $feeService, $walletService) {
            ...
            // Update total_earned — HANYA freelancer pemilik service ini
