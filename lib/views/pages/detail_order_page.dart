...
class _DetailOrderPageState extends State<DetailOrderPage> {
  ...
  Future<void> _pickAndUploadFile() async {
    ...
    const allowed = [
      'pdf', 'doc', 'docx', 'txt', 'zip', 'rar', 'psd', 'ai', 'fig'
    ];
  ...
  Future<void> _handleConfirmPay(
    double packagePrice, double adminFee, double total) async {
                    ...
                    child: Column(children: [
                      ...
                      _buildCard(
                        ...
                        children: [
                          ...
                          _buildPriceRow(
                              '$_packageLabel package', 'Rp ${_fmt(_packagePrice)}'),
                          const SizedBox(height: 4),
                          _buildPriceRow('Admin fee', 'Rp ${_fmt(adminFee)}'),
                          const Divider(height: 16),
                          _buildPriceRow('Total', 'Rp ${_fmt(total)}',
                              isBold: true),
                        ],
                      )),
                      const SizedBox(height: 12),
